% Simulation for LMS on Z axis
% Expanded State Space
clc;clear;close all;

%% Determine the FIR parameters initial value
...
pole = 0.4952;Qnum = [4670.29807752366;-2915.06315138601;2492.97016243023;-736.557047422892;1800.56681396059;1362.26065656813;510.851838799402;966.655615129803;1601.77515826129;366.553977436919;-472.515804825815;1471.75525011512;-2359.70115655455;2396.48621981079;-3552.30879248213].';
...
%% Detemine the constraints shape
...
rmse = rms(ek)*1000;
rmse_mid = rms(ek(oneperiod))*1000;
fprintf("(stste space)\nL: %d\nMax error: %.6f um\nRMS(all): %.6f um\nRMS(onewave): %.6f um\n", Lq, max_rmse, rmse, rmse_mid);


%% Show parameter growing curve
PlotQGrowingCurve("Q CURVE LMS Z",qk,Lq,t);

%% save
% data = struct('name',"X lms",...
%               'pole',pole,...
%               'Qnum',Qnum,...
%               'rk',rk,...
%               'yk',yk,...
